        ...
        <div className="container flex justify-between items-center">
                 ...
                 <ul className="flex items-center gap-4">
                    { MenuLinks.map((data,      index) => (
                        <li key={index}>
                            ...
                            font-semibold text-gray-500 hover:text-black dark:hover:text-white duration-200"
                            >
                                {" "}
                                {data.name}
                            </a>
                       ...
                       <ul className='space-y-2'>
                        {
                            DropdownLinks.map((data, index) => (
                                <li>
                                  <a className='text-gray-500 dark:hover:text-white duration-200 inline-block w-full p-2 hover:bg-primary/20 rounded-md font-semibold'
            ...
            <div className='flex justify-between items-center gap-4'>
                ...
                <div className='relative group hidden sm:block'>
                   ...
                   dark:text-gray-400 absolute top-1/2 -translate-y-1/2 right-0 duration-200"/> 
                </div>
